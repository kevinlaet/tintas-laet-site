...
- **Slide 1 (capa):** título grande, palavra-chave em destaque na cor da marca, nome da empresa embaixo. Variar a capa entre fundo claro / foto com gradient / fundo na cor principal — alternar pra criar ritmo no feed.
- **Slides internos:** alternar 2-3 layouts pra criar ritmo visual. Layouts comuns: texto centralizado, número grande no fundo + h2 + parágrafo, citação com aspas grandes, card com borda, split horizontal.
- **Slide final (CTA):** fundo na cor principal da marca, logo, headline curta, sub, botão/CTA, @ da marca.

Cores e tipografia: ler `identidade/design-guide.md`. Se ainda não foi preenchido, parar e pedir ao usuário pra rodar `/instalar` antes.
